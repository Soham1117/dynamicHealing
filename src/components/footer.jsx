    ...
    <div>
      <div className="hidden lg:flex flex-col border border-[#DADEE2] shadow-lg rounded-3xl lg:flex-row lg:flex-wrap gap-4 items-center lg:items-start lg:justify-evenly ml-4 mr-4 mt-12  min-h-[60vh]  font-poppins p-8 relative mb-8">
        ...
        <div className="flex flex-col gap-8 z-10">
          ...
          <div className="flex text-md text-[#68747A] items-start justify-start">
            <span>
            ...
            <div className="flex flex-row">
              ...
              <div className="flex flex-row gap-6 items-center w-1/2">
                ...
                <div className="flex flex-col text-wrap gap-4">
                  ...
                  <span className="text-md text-[#68747A]">
                    +91 98250 25020
                  </span>
                </div>
              </div>
        ...
        <div className="flex flex-col gap-8 z-20">
          ...
          <div className="flex flex-row gap-6 items-center w-full">
            ...
            <div className="flex flex-col text-wrap gap-4">
              ...
              <span className="text-md text-[#68747A]">+91 98250 25020</span>
            </div>
          </div>
