  ...
  return (
    <div>
      <div className="flex flex-col mx-4 lg:mx-24 gap-6 items-center lg:items-center lg:justify-evenly mt-20 min-h-[70vh] font-poppins">
        ...
        <div class="-mx-3 md:flex md:items-stretch">
          <div class="px-3 md:w-1/3 md:flex md:flex-col md:justify-between md:gap-6">
            <div class="w-full mx-auto rounded-lg bg-white border border-[#cfcac5] p-5 text-[#051b2e] font-light mb-6 md:mb-0 hover:shadow-lg hover:border-black transition-all ease-in-out duration-300">
        ...
        <div class="-mx-3">
          <div class="px-3">
            ...
            <div class="w-full flex mb-4 items-center">
              ...
              <div class="flex-grow pl-3">
                <h6 class="font-bold text-sm text-gray-600">Viraj Didwania</h6>
              </div>
            </div>
            <div class="w-full">
              <p class="text-sm leading-tight">
                ...
                Tanna for the incredible care and transformation he has brought
                into our lives. My father, Vimal ji, is 70 years old, and the
                difference in his health, energy levels, and mental positivity
                from when we first visited to now is truly remarkable-nothing
                short of a complete transformation.
              </p>
              <p class="text-sm leading-tight">
                ...
                understanding. For nearly 6-8 months, he was not fully ready to
                follow the process, yet you handled him with such calmness and
                compassion.
              </p>
              <p class="text-sm leading-tight">
              ...
              <p class="text-sm leading-tight">
                Thank you once again, Doctor, for your dedication, patience, and
                the positive transformation you have brought into both our lives.
                <span class="text-lg leading-none italic font-bold text-gray-400 ml-1">
                  "
                </span>
              </p>
